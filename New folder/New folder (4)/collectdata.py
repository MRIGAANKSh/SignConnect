...
# Create folders for extra signs
extra_signs = ["Done", "welcome", "i_love_you", "hello", "please", "sorry", "thank_you"]
...
while True:
    ...
    count = {
             ...
             "sorry": len(os.listdir(directory+"/sorry")),
             "thank_you": len(os.listdir(directory+"/thank_you"))
             }
    ...
    if interrupt & 0xFF == ord('/'):
        cv2.imwrite(os.path.join(directory+'Done/'+str(count['Done']))+'.jpg',frame)
    if interrupt & 0xFF == ord('.'):
        cv2.imwrite(os.path.join(directory+'blank/' + str(count['blank']))+ '.jpg',frame)

    # 🆕 Extra key mappings for new signs
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(os.path.join(directory+'welcome/' + str(count['welcome']))+ '.jpg',frame)
    ...
    if interrupt & 0xFF == ord('4'):
        cv2.imwrite(os.path.join(directory+'please/' + str(count['please']))+ '.jpg',frame)
    if interrupt & 0xFF == ord('5'):
        cv2.imwrite(os.path.join(directory+'sorry/' + str(count['sorry']))+ '.jpg',frame)
    if interrupt & 0xFF == ord('6'):
        cv2.imwrite(os.path.join(directory+'thank_you/' + str(count['thank_you']))+ '.jpg',frame)
